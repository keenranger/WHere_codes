...
## 200625.db (6월 24일 스윙 모션 테스트)
* smr : 제자리에서 스윙(오른손)
* sml : 제자리에서 스윙(왼손)

* msmr : 보고걷기(10걸음) - 스윙(40걸음) - 보고걷기(10걸음)   - 오른손
* msml : 보고걷기(10걸음) - 스윙(40걸음) - 보고걷기(10걸음)   - 왼손 

* msmr2 : 창수 스윙모션 한바퀴 (오른손)
* msmr3 : 동현이형 스윙모션 한바퀴 (오른손) 
* msmr4 : 창수 스윙모션 한바퀴(반시계) (오른손)
* msmr5 : 범주형 스윙모션 두바퀴 (오른손)

## 200626_h.db (6월 24일 스윙 모션 테스트)
* swing01 : 한결 스윙모션 두바퀴(스윙 강도 달리하며)
* five01 : 한결 5바퀴 (모션 바꿔가며)
...
## 200703.db
* mgt1 : 보고걷기 - 전화 - 스윙 - 주머니(뒤) - 주머니(앞) -가방모션1- 가방모션2  (오른손)
* mgt2 : 왼손 
